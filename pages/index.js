...
export default function Home() {
  ...
  const projects = [
    ...
    { title: "Neural Pilot – Hill Climb AI", tech: ["Python", "Deep RL", "Pymunk"], desc: "Developed a Deep Reinforcement Learning agent for a physics-based vehicle control problem. Implemented Proximal Policy Optimization (PPO) to master complex terrains in a simulated environment." },
    { title: "NLP Menu vs Delivery Analysis", tech: ["Python", "NLP", "Analytics"], desc: "Conducted sentiment analysis on food application reviews to identify correlation between menu quality and delivery efficiency. Utilized keyword extraction for actionable business insights." },
    { title: "Fake Product Review Detection", tech: ["NLP", "Python", "ML"], desc: "Engineered a classification model to detect fraudulent reviews. Applied text preprocessing (tokenization, lemmatization) and TF-IDF vectorization to identify suspicious patterns in user feedback." },
    { title: "Finance Tracker", tech: ["Flask", "SQLite", "Chart.js"], desc: "Full-stack personal finance application. Features secure user authentication, categorized expense logging, and interactive data visualization of spending habits." }
  ];
  ...
  const experience = [
    { role: "Data Analyst Intern", company: "Tech Vaseegrah", date: "07/2024 – 08/2024", points: ["Analyzed and visualized business data using Python, Excel, and SQL.", "Developed a real-world billing dashboard application using Flask to streamline internal reporting."] },
    { role: "AI & ML Trainee", company: "Rexroth Bosch Group", date: "Dec 2024 – Jan 2025", points: ["Applied Deep Learning concepts to industrial sensor datasets.", "Built predictive maintenance prototypes using regression and classification models."] }
  ];
      ...
      <div className="min-h-screen bg-[#030712] text-slate-200 font-sans selection:bg-violet-500/30 overflow-x-hidden">
        ...
        <section className="pt-64 pb-32 px-6 flex flex-col items-center text-center relative">
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-10 text-[10px] font-mono text-violet-400 uppercase tracking-widest font-bold font-mono">
            $ Initializing_Data_Expertise_v3.0
          </motion.div>
          ...
          <p className="max-w-2xl text-slate-400 text-xl font-light mb-12 italic leading-relaxed">
            "Bridging the gap between mathematical theory and <span className="text-white border-b border-violet-500/50">intelligent systems</span>."
          </p>
        ...
        <section id="about" className="max-w-5xl mx-auto px-6 py-32 border-t border-white/5">
          <div className="grid lg:grid-cols-3 gap-16">
            <div className="sticky top-40 h-fit">
              <h2 className="text-4xl font-extrabold text-white tracking-tighter uppercase">Creative</h2>
              <span className="text-violet-500 font-light italic text-2xl uppercase tracking-widest">Summary</span>
            </div>
            <div className="lg:col-span-2 space-y-8 text-slate-400 text-lg leading-relaxed">
              <p>
                I am a highly analytical <span className="text-white font-semibold">Data Science professional</span> currently pursuing my <span className="text-white">M.Sc. at PMIST</span>. My academic journey is built on a solid foundation from my B.Sc. in Data Science, where I maintained a CGPA of 7.51.
              </p>
              <p>
                My core expertise lies in architecting <span className="text-violet-400 font-bold">Deep Learning models</span> and <span className="text-violet-400 font-bold">NLP pipelines</span>. I have successfully deployed predictive systems ranging from time-series stock forecasting to autonomous Reinforcement Learning agents. I pride myself on turning raw, complex data into strategic business insights.
              </p>
              <div className="p-8 rounded-[32px] bg-violet-500/5 border border-violet-500/10 italic text-slate-300">
                "Whether I am optimizing ETL processes or fine-tuning neural networks, my objective is to engineer data solutions that are both scalable and impactful."
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="skills" className="max-w-7xl mx-auto px-6 py-32 bg-[#050a18]/30">
          ...
          <div className="grid md:grid-cols-2 gap-8 text-white">
            <div className="p-12 rounded-[48px] bg-[#0b0f1a] border border-white/5 shadow-2xl hover:border-violet-500/30 transition-all">
              <h3 className="text-2xl font-bold mb-10 underline decoration-violet-500/30 underline-offset-8 uppercase tracking-widest flex items-center gap-4"><span>💻</span> Programming</h3>
            ...
            <div className="p-12 rounded-[48px] bg-[#0b0f1a] border border-white/5 shadow-2xl hover:border-violet-500/30 transition-all">
              <h3 className="text-2xl font-bold mb-10 underline decoration-violet-500/30 underline-offset-8 uppercase tracking-widest flex items-center gap-4"><span>🤖</span> AI & Machine Learning</h3>
              <div className="flex flex-wrap gap-3">
            ...
            {projects.map((proj, i) => (
              <div key={i} onClick={() => setSelectedProject(proj)} className="p-10 bg-[#0b0f1a] border border-white/5 rounded-[56px] cursor-pointer hover:border-violet-500/50 transition-all h-[440px] flex flex-col justify-between shadow-2xl group text-white">
                <div>
                  ...
                  <p className="text-slate-500 text-sm italic mt-4">Click to view Architecture →</p>
                </div>
                <div className="w-12 h-12 rounded-3xl bg-white/5 flex items-center justify-center text-violet-500 self-end transition-all transform group-hover:rotate-45">↗</div>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="max-w-5xl mx-auto px-6 py-32 border-t border-white/5">
          <div className="p-16 rounded-[56px] bg-gradient-to-br from-[#0b0f1a] to-transparent border border-white/5 shadow-2xl text-white">
            ...
            <ul className="space-y-4 text-slate-500 text-sm leading-relaxed font-bold uppercase tracking-wider">
              <li className="flex gap-3"><span className="text-violet-500">▹</span> Organized technical workshops, seminars, and university-wide technical events.</li>
              <li className="flex gap-3"><span className="text-violet-500">▹</span> Collaborated with the internal technical team for campus systems optimization.</li>
          ...
          {selectedProject && (
            <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
              ...
              <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.9, opacity: 0 }} className="relative bg-[#0b0f1a] border border-white/10 p-16 rounded-[64px] max-w-3xl w-full text-white shadow-2xl text-center">
                ...
                <button onClick={() => setSelectedProject(null)} className="py-6 px-12 bg-white/5 border border-white/10 rounded-3xl font-bold hover:bg-white/10 transition-all uppercase text-xs tracking-[0.3em] font-bold">Close Details</button>
              </motion.div>
            </div>
          )}
        </AnimatePresence>

      ...
      <div className="w-full max-w-5xl bg-[#0b0f1a]/80 backdrop-blur-md border border-white/10 rounded-xl px-6 py-2 flex justify-between items-center shadow-xl font-bold">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col text-left">
            <span className="text-white font-black text-sm tracking-tighter uppercase leading-none">Rakesh G</span>
...
export default function Home() {
  ...
  const projects = [
    { title: "Stock Market Prediction (LSTM)", tech: ["Python", "LSTM", "TensorFlow"], desc: "Architected a deep LSTM network to capture temporal dependencies in financial cycles. Processed 5+ years of historical market data to forecast closing prices with optimized windowing.", link: "https://github.com/Rakesh-developer28/stock_prediction" },
    { title: "Neural Pilot – Hill Climb AI", tech: ["Deep RL", "Pymunk", "Python"], desc: "Designed an autonomous agent using Proximal Policy Optimization (PPO). The agent masters physical vehicle control through reward-shaping in a 2D physics environment.", link: "https://github.com/Rakesh-developer28/Neural-Pilot-Hill-Climb-AI" },
    { title: "Menu vs Delivery NLP", tech: ["NLP", "VADER", "Python"], desc: "Mining project distinguishing product quality from service efficiency in food tech apps using lemmatization and sentiment scoring for business insights.", link: "https://github.com/Rakesh-developer28/menu-delivery-nlp-analysis" },
    { title: "Personal Finance Tracker", tech: ["Flask", "SQLite", "Chart.js"], desc: "Full-stack dashboard with custom ETL pipelines to transform raw transaction logs into dynamic spend visualizations and financial reports.", link: "https://github.com/Rakesh-developer28/finance_tracker" },
    { title: "Fake Product Review Detection", tech: ["ML", "NLP", "Scikit"], desc: "Engineered a classification model to detect fraudulent reviews using TF-IDF vectorization and text preprocessing for e-commerce security." }
  ];
      ...
      <div className="min-h-screen bg-[#020617] text-slate-300 font-sans selection:bg-violet-500/30 overflow-x-hidden">
        ...
        <section className="pt-48 pb-24 px-6 flex flex-col items-center text-center">
          ...
          <p className="max-w-2xl text-slate-400 text-lg md:text-xl font-light mb-10 italic leading-relaxed">
            "Bridging the gap between mathematical theory and <span className="text-white border-b border-violet-600">intelligent systems</span>."
          </p>
        ...
        {/* PROFESSIONAL SUMMARY - FULL DATA */}
        <section id="about" className="max-w-4xl mx-auto px-6 py-24 border-t border-white/5">
          ...
          <div className="space-y-6 text-slate-400 text-base leading-relaxed text-justify font-medium">
            ...
            <p>I maintained a **CGPA of 7.51 / 10.0** during B.Sc., combining mathematical theory with practical software engineering at **Tech Vaseegrah** and **Rexroth Bosch**.</p>
          </div>
        </section>
        ...
        <section id="skills" className="max-w-6xl mx-auto px-6 py-20 bg-[#030712]/50">
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="p-8 rounded-3xl bg-[#0b0f1a] border border-white/5 text-center font-bold">
        ...
        {/* JOURNEY - ALL DATA RESTORED */}
        <section id="experience" className="max-w-4xl mx-auto px-6 py-24 border-t border-white/5 text-left">
          ...
          <div className="space-y-12 mb-20">
            <div className="relative pl-8 border-l-2 border-violet-600/30">
              ...
              <p className="text-violet-400 font-bold text-[10px] mb-4 uppercase tracking-widest font-bold">PMIST | Periyar Maniammai Institute</p>
              <p className="text-sm text-slate-500 font-bold italic uppercase tracking-wider leading-relaxed">Focusing on Deep Learning architectures, Transformers, and LLM fine-tuning.</p>
            </div>
            <div className="relative pl-8 border-l-2 border-violet-600/30">
              <div className="absolute w-4 h-4 bg-violet-600 rounded-full -left-[9px] top-1 shadow-[0_0_10px_#8b5cf6]"></div>
              <h3 className="text-lg font-black text-white uppercase">B.Sc. Data Science | 2022 – 2025</h3>
              <p className="text-violet-400 font-bold text-[10px] mb-2 uppercase tracking-widest font-bold">PMIST | Graduated</p>
          ...
          <div className="p-10 rounded-3xl bg-[#0b0f1a] border border-white/5 shadow-xl mb-12">
            <h3 className="text-xl font-bold text-violet-400 uppercase mb-6 flex items-center gap-4 font-bold"><span>📢</span> Class Representative</h3>
          ...
          <div className="p-8 rounded-3xl bg-[#0b0f1a] border border-white/5">
            ...
            <p className="text-slate-200 text-[10px] font-black uppercase mb-6 tracking-widest font-bold">Tech Vaseegrah | 07/2024 – 08/2024</p>
            <ul className="text-slate-500 text-sm space-y-2 font-bold uppercase tracking-wider">
              <li>▹ Analyzed business data using Python & SQL to generate KPIs.</li>
              <li>▹ Built a dynamic billing dashboard application using Flask.</li>
            </ul>
          </div>
        </section>
        ...
        <section id="certs" className="max-w-5xl mx-auto px-6 py-24 border-t border-white/5">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="rounded-xl overflow-hidden border border-white/5 bg-[#0b0f1a] p-4 text-center">
              <img src="/cert1.png" alt="Cert 1" className="w-full h-auto rounded-lg mb-4 opacity-70 hover:opacity-100 transition-all cursor-zoom-in grayscale hover:grayscale-0" />
              <p className="text-[9px] text-slate-500 font-black uppercase tracking-widest">Analytics & Data Architecture</p>
            </div>
            <div className="rounded-xl overflow-hidden border border-white/5 bg-[#0b0f1a] p-4 text-center">
              <img src="/cert2.png" alt="Cert 2" className="w-full h-auto rounded-lg mb-4 opacity-70 hover:opacity-100 transition-all cursor-zoom-in grayscale hover:grayscale-0" />
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 font-bold">
            {projects.map((proj, i) => (
              <div key={i} onClick={() => setSelectedProject(proj)} className="p-8 bg-[#0b0f1a] border border-white/5 rounded-3xl cursor-pointer hover:border-violet-600 transition-all shadow-xl group">
                ...
                <div className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center text-violet-600 self-end font-bold transition-all transform group-hover:rotate-45 font-bold tracking-widest">↗</div>
              </div>
            ))}
          </div>
        </section>

        {/* CONNECT - COMPACT & ALIGNED */}
        <footer id="contact" className="py-24 text-center border-t border-white/5 bg-black/40">
          <h2 className="text-3xl md:text-5xl font-black text-white mb-12 uppercase tracking-tighter italic font-light">Get In <span className="text-violet-600 font-black">Touch</span></h2>
          <div className="flex flex-wrap justify-center gap-4 px-6 font-bold uppercase text-[9px]">
            ...
            <a href="https://linkedin.com/in/rakeshgdev" target="_blank" className="flex items-center gap-3 bg-[#0077b5] px-6 py-4 rounded-xl text-white font-black">LinkedIn</a>
          </div>
          <p className="mt-16 text-slate-700 text-[8px] tracking-[0.6em] font-mono font-bold uppercase">© 2026 RAKESH G | DATA SCIENCE | PMIST</p>
        </footer>
          ...
          {selectedProject && (
            <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
              ...
              <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.9, opacity: 0 }} className="relative bg-[#0b0f1a] border border-white/10 p-10 rounded-[32px] max-w-xl w-full text-white shadow-2xl text-center">
                ...
                <p className="text-slate-400 text-sm mb-10 italic uppercase font-bold tracking-widest leading-relaxed font-bold">{selectedProject.desc}</p>
                <div className="flex gap-4">

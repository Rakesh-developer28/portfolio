...
export default function Home() {
  ...
  const projects = [
    { title: "Stock Market Prediction (LSTM)", tech: ["Python", "LSTM", "TensorFlow"], desc: "Designed and trained LSTM models for time series forecasting of stock prices using historical market data. Implemented data preprocessing, feature engineering, and model tuning." },
    ...
    { title: "Neural Pilot – Hill Climb AI", tech: ["Python", "Deep RL", "TensorFlow"], desc: "Developed a Deep Reinforcement Learning agent for a physics-based control problem using TensorFlow, Pygame, and Pymunk.", link: "https://github.com/Rakesh-developer28/Neural-Pilot-Hill-Climb-AI" },
    { title: "Menu vs Delivery NLP Analysis", tech: ["Python", "NLP", "Analytics"], desc: "Analyzed food app reviews to compare menu quality vs delivery impact via sentiment analysis.", link: "https://github.com/Rakesh-developer28/menu-delivery-nlp-analysis" },
    { title: "Finance Tracker", tech: ["Flask", "SQLite", "Chart.js"], desc: "Full-stack personal finance tracker built using Flask and SQLite with dynamic data visualization.", link: "https://github.com/Rakesh-developer28/finance_tracker" }
  ];
  ...
  const experience = [
    ...
    { role: "AI & ML Trainee", company: "Rexroth Bosch Group", date: "Dec 2024 – Jan 2025", points: ["Industrial AI training using sensor datasets and predictive ML models."] }
  ];
    ...
    <div className="min-h-screen bg-[#030712] text-slate-200 font-sans selection:bg-violet-500/30 overflow-x-hidden">
      ...
      <section id="projects" className="max-w-7xl mx-auto px-6 py-24 border-t border-white/5">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((proj, i) => (
            <motion.div key={i} onClick={() => setSelectedProject(proj)} whileHover={{ y: -10 }} className="p-10 bg-[#0b0f1a] border border-white/5 rounded-[40px] cursor-pointer hover:border-violet-500/50 transition-all h-[440px] flex flex-col justify-between shadow-lg text-white">
              <div>
                ...
                <h4 className="text-3xl font-bold mb-4 leading-tight group-hover:text-violet-400">{proj.title}</h4>
      ...
      <section id="education" className="max-w-5xl mx-auto px-6 py-32 border-t border-white/5">
        ...
        <div className="relative border-l border-white/10 ml-4 space-y-16 text-white">
          {education.map((edu, i) => (
